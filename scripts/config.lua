...
CONFIG = {
    ...
    start_money = 150,  -- стартовый капитал игрока (монет)
    rent_amount = 15,   -- аренда магазина за период (монет)
    rent_interval_secs = 60, -- период оплаты аренды (сек)
    ...
    -- === Интерфейс ===
    font_path = "assets/font.otf",  -- путь к файлу шрифта (меняется при перезапуске)
}
