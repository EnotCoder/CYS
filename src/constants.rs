...
pub const INV_OUTDOOR: &[&str] = &["street_fence", "tree", "pink_flower", "blue_flower"];
pub const OUTDOOR_NAMES: [&str; 4] = ["street_fence", "tree", "pink_flower", "blue_flower"];
pub const FLOWER_NAMES: [&str; 2] = ["pink_flower", "blue_flower"];
