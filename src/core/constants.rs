...
// Погода (снег/дождь) рисуется над декорациями и NPC, но под курсором и UI.
pub const Z_WEATHER: f32 = 1.9;
pub const Z_UI: f32 = 3.0;
// Тексты UI всегда поверх панелей/инвентаря (панели живут на Z_UI),
// иначе при пересоздании текста порядок может оказаться позади панели.
pub const Z_UI_TEXT: f32 = 3.005;
