...
pub fn token_to_texture(token: &str, season: crate::ecs::components::Season) -> (&str, [i32; 2], [i32; 2]) {
    ...
    match token {
        ...
        "/" => ("assets/tex/map/wall.png", [0, 2], [5, 5]),
        "|" => ("assets/tex/map/wall.png", [1, 2], [5, 5]),
        "(" => ("assets/tex/map/wall.png", [0, 3], [5, 5]),
        "{" => ("assets/tex/map/wall.png", [0, 4], [5, 5]),
        ")" => ("assets/tex/map/wall.png", [1, 3], [5, 5]),
        "}" => ("assets/tex/map/wall.png", [1, 4], [5, 5]),
        //window
