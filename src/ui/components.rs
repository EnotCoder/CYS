...
// ========================================================================
//  Описания UI-элементов (только данные, сущности создают функции system.rs):
//  Panel (подложка), Button (фон + текст), Checkbox (галочка + подпись),
//  Slider (дорожка, ползунок, флаг dragging).
// ========================================================================
